    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-background px-4 transition-colors">
        <div className="max-w-md w-full bg-surface rounded-xl shadow-lg p-8 text-center animate-in fade-in zoom-in duration-300 border border-border">
          ...
          <h1 className="text-2xl font-bold mb-2 text-text-main">Setup Required</h1>
          <p className="text-text-muted mb-6">
            Please configure the Google Sheets backend URL to start using TripSplit.
          </p>
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background px-4 transition-colors">
      <div className="max-w-md w-full bg-surface rounded-xl shadow-lg p-8 animate-in fade-in zoom-in duration-300 border border-border">
        <h1 className="text-3xl font-bold text-center text-primary mb-2">TripSplit</h1>
        <p className="text-center text-text-muted mb-8">Secure Travel Expense Tracker</p>
        
        <form onSubmit={handleLogin} className="space-y-4">
          <div>
             <label className="block text-sm font-medium mb-1 text-text-main">Email Access</label>
             <input 
              type="email" 
              required
             ...
             <p className="text-xs text-text-muted mt-2">
               Allowed: {config.allowedEmails.slice(0, 3).join(', ')}
        ...
        <div className="mt-6 pt-6 border-t border-border text-center">
           <Link to="/settings" className="text-sm text-primary hover:underline flex items-center justify-center gap-1">
